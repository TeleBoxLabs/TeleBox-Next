  ...
  private async handleHelp(msg: MessageContext) {
    try {
      ...
      if (args.length === 0) {
        ...
        const links = `🔗 <a href='https://github.com/TeleBoxOrg/TeleBox-Next'>📦仓库</a> | <a href='https://github.com/TeleBoxOrg/TeleBox-Next-Plugins'>🔌插件</a> | <a href='https://t.me/teleboxdevgroup'>👥群组</a> | <a href='https://t.me/teleboxdev'>📣频道</a> | <a href='https://telegra.ph/TeleBox-插件列表-03-03'>📚插件列表</a>`;
